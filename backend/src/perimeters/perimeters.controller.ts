...
export class PerimetersController {
  ...
  create(
    ...
    return this.perimetersService.createPerimeter(
      projectId,
      req.user.userId,
      body,
    );
  ...
  assign(
    ...
    @Param('perimeterId') perimeterId: string,
    @Request() req: any,
  ) {
    return this.perimetersService.assignToHypothesis(
      hypothesisId,
      perimeterId,
      req.user.userId,
    );
  ...
  removeFromHypothesis(
    ...
    return this.perimetersService.removeFromHypothesis(
      hypothesisId,
      perimeterId,
      req.user.userId,
    );
