    ...
    <div className="flex h-screen" style={{background:'#0f1117'}}>
      ...
      <aside className="w-56 flex flex-col border-r" style={{background:'#161b27', borderColor:'#1e2535'}}>
        ...
        <div className="px-3 py-2">
          <p className="text-xs font-semibold px-3 mb-2" style={{color:'#4b5568'}}>NAVIGATION</p>
        ...
        <div className="mt-auto px-3 py-4 border-t" style={{borderColor:'#1e2535'}}>
          <div className="flex items-center gap-3 px-3 py-2.5 rounded-lg mb-1" style={{background:'#1e2535'}}>
